...
import { HttpPublicService } from '../../../services/http.service.public';
import { IAttorneyPrefillData } from '../../../types/IAttorneyPrefillData';

@Component({
    selector: 'app-modal-generate-dispositions',
    templateUrl: './modal-generate-dispositions.component.html',
    styleUrls: ['./modal-generate-dispositions.component.css']
})
